...
## Prerequisites
!!!
For developing the WasmEdge plug-in in C API, please [install WasmEdge](https://wasmedge.org/book/en/quick_start/install.html) first.
!!!
...
The goal of the plug-in is to provide the host functions which can be imported when instantiating WASM. Therefore, developers can implement their plug-in host functions first, as the same as the [host functions in WasmEdge C API](https://wasmedge.org/book/en/sdk/c/ref.html#host-functions).

!!!
For the more details about the [external data](https://wasmedge.org/book/en/sdk/c/hostfunction.html#host-data) and [calling frame context](https://wasmedge.org/book/en/sdk/c/hostfunction.html#calling-frame-context), please refer to the host function guide.
!!!
